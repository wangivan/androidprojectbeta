...
import cn.rongcloud.im.ui.activity.SingleWorkShopOutPutDataChartActivity;
...
public class OutPutReportLinkedTableAdapter extends BaseAdapter {

    public final static String KEY= "WORKSHOP";
    private List<Map<String, Object>> data;
    private LayoutInflater layoutInflater;
    private Context context;
    public OutPutReportLinkedTableAdapter(Context context, List<Map<String, Object>> data){
...
//                    context.startActivity(new Intent());
                    Intent intent = new Intent(context,SingleWorkShopOutPutDataChartActivity.class);
