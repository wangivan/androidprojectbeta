...
//                            RongIM.getInstance().insertMessage(Conversation.ConversationType.GROUP, mGroupId, "85", new MessageContent() {
//                                @Override
//                                public byte[] encode() {
//                                    return new byte[0];
//                                }
