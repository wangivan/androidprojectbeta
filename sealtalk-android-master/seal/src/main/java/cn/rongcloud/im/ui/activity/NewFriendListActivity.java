...
public class NewFriendListActivity extends BaseActivity implements NewFriendListAdapter.OnItemButtonClick {
    ...
    private static final int GETFRIEND = 13;
    ...
    public Object doInBackground(int requestCode, String id) throws HttpException {
        switch (requestCode) {
            case GETFRIEND:
                ...
                return  action.getAllUserFriend(userId2);
            case GETALL:
                String userId1 = mContext.getSharedPreferences("config", Context.MODE_PRIVATE).getString("loginid", "");
                return action.getAllUserRelationship(userId1);
            case AGREEFRIENDS:
                String userId = mContext.getSharedPreferences("config", Context.MODE_PRIVATE).getString("loginid", "");
                return action.agreeFriends(userId,friendId);
        }
