...
public class MainActivity extends BaseActivity implements ViewPager.OnPageChangeListener, View.OnClickListener, DragPointView.OnDragListencer {
    ...
    private RelativeLayout homeRLayout, chatRLayout, contactRLayout, foundRLayout, mineRLayout;
    ...
    private void initViews() {
        homeRLayout = (RelativeLayout)findViewById(R.id.seal_chat0);
        ...
        homeRLayout.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.seal_contact_list:
                ContactsFragment.getInstance().updateUI();
